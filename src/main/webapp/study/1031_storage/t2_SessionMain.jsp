...
<div class="container">
	...
	<form name="myform method="post" action="t2_SessionSave.jsp">
		<div>아이디:
			<input type="text" name="mid" value="hkd1234" autofocus class="form-control"/>
		</div>
		<div>닉네임:
			<input type="text" name="nickName" value="홍장군" autofocus class="form-control"/>
		</div>
		<div>성명:
		...
		<div class="row">
			...
			<div class="col"><a href="t2_SessionCheck.jsp" class="btn btn-primary form-control">세션 확인</a></div>
